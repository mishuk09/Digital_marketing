                ...
                <>
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 navbar-head-parants">
                        <div className="relative flex h-16 items-center justify-between navbar-head-child">
                            ...
                            <div className="flex flex-1 justify-center items-center text-center sm:items-stretch sm:justify-start navbar-head-child1">
                                ...
                                <div className="hidden sm:ml-6 my-2 md:ml-[0px] lg:ml-[300px] xl:ml-[420px]  text-right items-end justify-end   sm:block navbar-head-child2">
                    ...
                    <Disclosure.Panel className="sm:hidden">
                        <div className="space-y-1 px-2 pb-3 pt-2 flex flex-col">
                            ...
                            <DropdownMenu />
                            <div className="  inset-y-0 right-0     md:hidden  flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0 navbar-child-child">
                                <Link to='/contactpage'>
                                    <ButtonFormet > Get a Call</ButtonFormet>
                                </Link>
                            </div>
                        </div>
                    </Disclosure.Panel>
