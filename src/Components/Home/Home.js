        ...
        <div clsssName='xs:w-full'>
            ...
            <div style={clipPathStyle} className='bg-slate-200   absolute w-full xs:w-full xs:h-[1000px] sm:h-[700px] h-[700px] flex flex-col text-center'>
                <div className='container xs:w-full'>
                    ...
                    <p className='text-slate-600 xs:w-[100%]  sm:w-full md:w-[50%] w-[50%] mx-auto mt-4  font-nunito '>Welcome to [Your Company Name], your gateway to digital success! Elevate your brand with our cutting-edge strategies, driving meaningful growth. </p>
